...
| **v1.2** | Session persist + пагинация + фильтрация | 🔄 Планируется |
...
**Статус:** ✅ v1.1 — парсинг деталей + Telegram-уведомления работают

---

*Создано: 2026-02-05*
*Версия: 1.2*
*Обновлено: 2026-02-23 — v1.1 с парсингом деталей и Telegram*
